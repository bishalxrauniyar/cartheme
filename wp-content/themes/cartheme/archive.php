 <!-- // not used in this theme but can be used to display all posts of a custom post type in a single page , the achive page is used to display all posts of a custom post type in a single page , in this theme this can be achive by the search page with no parameters passing in the search form -->
